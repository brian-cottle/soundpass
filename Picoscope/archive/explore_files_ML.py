...
class AnnotateSignalSlider(QtWidgets.QWidget):
    def __init__(self, top_level_directory, title="Signal Annotator with Slider"):
        ...
        weights_file = '/home/briancottle/Code/SoundPass/Live_Models/cadaver_model_v02_10.pth' # Replace with the actual path to the weights file
    ...
    def plot_data(self):
        ...
        self.plot_widget.plot(self.distance, self.data, pen=pg.mkPen(color=(0, 255, 0, 50)))
        self.plot_widget.plot(self.distance, self.extracted_wavelet_data, pen=pg.mkPen(color=(255, 0, 0, 250)))
        # Set y-axis range
        self.plot_widget.setYRange(0, 500)  # You can adjust these values as needed
    ...
    def perform_segmentation(self):
        ...
        binary_prediction = (self.extracted_wavelet_data > self.segmentation_threshold).astype(int)
