import sys
import numpy as np
from PyQt5.QtWidgets import QApplication, QSlider, QFileDialog
...
from live_orientation_utils import BaseVisualizationMixin, low_pass_filter, downsample_data
...
class TimeSeriesPlayback(BaseVisualizationMixin):
    ...
    def setup_gui(self):
        ...
        self.w.setWindowTitle('Pitaya Offline Guidance Playback')
    ...
    def setup_playback_controls(self, layout):
        ...
        # Progress slider (PyQt5 compatible)
    ...
    def toggle_playback(self):
        ...
        if self.is_playing:
            ...
            self.playback_timer.start(100)  # ~10Hz playback rate
        else:
    ...
    def setup_video_writer(self):
        ...
        if self.data_directory:
            ...
            self.video_writer = cv2.VideoWriter(
                ...
                fourcc,
                10.0,  # 10 FPS matching the playback rate
                self.frame_size
            )
    ...
    def update_plot(self):
        ...
        # Average samples (2D array to 1D)
        ...
        # Process and update wavelet plot
        ...
        # Handle orientation visualization
        ...
        # Step forward if playing
        if self.is_playing:
            self.current_file_index += 1

    def update_orientation_display(self, orientation):
        """Update orientation overlay on the polar plot"""
        try:
    ...
    def btn_pressed(self):
        """Toggle recording state placeholder for playback"""
...
if __name__ == '__main__':
    playback = TimeSeriesPlayback(None, screen_resolution="medium")
    playback.run()
